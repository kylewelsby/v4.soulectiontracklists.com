...
export default {
  ...
  computed: {
    youTubeEmbeddedURI() {
      return `https://www.player.vimeo.com/video/${this.youtubeID}?h=979f40c657&autoplay=1&color=ebff00&title=0&byline=0&portrait=0&badge=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" allow="autoplay; fullscreen; picture-in-picture"`
    },
  },
}
</script>
