<template lang="pug">
  div(
    ...
    div(
      class="container mx-auto p-4 py-8 flex flex-col lg:flex-row relative items-start"
    )
      nuxt-img(
        src="/soulection/home/UNTITLED_1-1_Dark.png"
        class="rounded-xl md:rounded-2xl w-full h-[380px] inline-block object-contain"
        width="1536"
        fit="contain"
        provider="twicpics"
      )
