  ...
  div(
    ...
    div(
      ...
      nuxt-img(
        ...
        class="rounded-xl md:rounded-2xl w-full h-[380px] inline-block object-cover"
        width="1536"
        fit="contain"
        provider="twicpics"
      )
      div(
        class="absolute z-10 top-0 left-0 bottom-0 right-0 flex flex-col items-center justify-contain"
      )
        //- span(
